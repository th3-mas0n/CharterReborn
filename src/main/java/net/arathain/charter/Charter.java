...
public class Charter implements ModInitializer {
    ...
    public static final Item CONTRACT = new ContractItem(new Item.Settings().maxCount(3).rarity(Rarity.RARE).group(ItemGroup.COMBAT));
    public static final Item DAWNBREAKER = new DawnBrakerItem(
            ToolMaterials.NETHERITE, 5, -3.0F, new Item.Settings().maxCount(1).rarity(Rarity.RARE).group(ItemGroup.COMBAT)
    );
    public static final Item SOUL_VESSEL = new SoulVesselItem(new Item.Settings().maxCount(3).rarity(Rarity.RARE).group(ItemGroup.COMBAT));
    ...
    public static final Block MONOLITH = new MonolithBlock(FabricBlockSettings.copyOf(Blocks.REINFORCED_DEEPSLATE).luminance(7).nonOpaque());
    ...
    public void onInitialize() {
        ...
        Registry.register(Registry.ITEM, new Identifier(MODID, "dawnbreaker"), DAWNBREAKER);
        Registry.register(Registry.ITEM, new Identifier(MODID, "soul_vessel"), SOUL_VESSEL );
        ...
        Registry.register(Registry.ITEM, new Identifier(MODID, "charter_soul_vessel"), new BlockItem(CHARTER_SOUL_VESSEL, new FabricItemSettings().group(ItemGroup.COMBAT)));
        Registry.register(Registry.BLOCK, new Identifier(MODID, "charter_soul_vessel"), CHARTER_SOUL_VESSEL);
        ...
        Registry.register(Registry.ITEM, new Identifier(MODID, "swapper"), new BlockItem(SWAPPER, new FabricItemSettings().group(ItemGroup.COMBAT)));
        Registry.register(Registry.BLOCK, new Identifier(MODID, "swapper"), SWAPPER);
        SOUL_VESSEL_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(MODID, "charter_vessel"), FabricBlockEntityTypeBuilder.create(SoulVesselBlockEntity::new, CHARTER_SOUL_VESSEL).build(null));
        MONOLITH_ENTITY = Registry.register(Registry.BLOCK_ENTITY_TYPE, new Identifier(MODID, "monolith"), FabricBlockEntityTypeBuilder.create(MonolithEntity::new, MONOLITH).build(null));
        ...
        Registry.register(Registry.STATUS_EFFECT, new Identifier(MODID, "repercussion"), REPERCUSSION);
        ...
        Registry.register(Registry.ITEM, new Identifier(MODID, "monolith"), new BlockItem(MONOLITH, new FabricItemSettings().group(ItemGroup.COMBAT)));
        Registry.register(Registry.BLOCK, new Identifier(MODID, "monolith"), MONOLITH);
        Registry.register(Registry.ITEM, new Identifier(MODID, "apex_focus"), new Item(new FabricItemSettings().group(ItemGroup.COMBAT)));
