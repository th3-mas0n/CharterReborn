...
public class MonolithMarksModel extends AnimatedGeoModel<MonolithEntity> {
    private static final Identifier TEXTURE_IDENTIFIER = new Identifier(Charter.MODID, "textures/block/monolith.png");
    private static final Identifier MODEL_IDENTIFIER = new Identifier(Charter.MODID, "geo/monolith_marks.geo.json");
